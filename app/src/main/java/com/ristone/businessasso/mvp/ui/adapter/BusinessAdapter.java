 ...
 */
public class BusinessAdapter extends BaseQuickAdapter<BusinessBean> {

    public BusinessAdapter(int layoutResId, List<BusinessBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder baseViewHolder, BusinessBean likeModel) {
